  ...
  <body>
    <div class="container" style="width: 100%">
      ...
      <span class="text-description" style="font-size: 1.1em">Welcome to xer0.led - simply fill out the fields below to update your screen. Reloading this page, or hitting submit without entering any text will clear your screen if you would like to turn it off. To turn it on, simply enter text and hit submit.
        <form name="logout" method="post" action="senderani.php">
      ...
      <div name="admin" class="wow fadeInUp content-card" style="margin-top: 0;">
        ...
        <div class="detail-item">
          ...
          <span class="text-description" style="color: rgb(<?php echo $visColour ?>)">Message changed to "
            ...
            <br>
            <!-- form -->
            <form method="post" action="senderani.php">
              <!-- intro -->
          ...
          <span>Animaton changed to: "
            ...
            <form method="post" action="senderani.php">
              ...
              <label class="mdl-radio mdl-js-radio mdl-js-ripple-effect" for="sword">
                <input type="radio" id="sword" class="mdl-radio__button" name="1colour" value="128,128,128" checked>
                <span class="mdl-radio__label">Sword
                </span>
              </label><br>
              <label class="mdl-radio mdl-js-radio mdl-js-ripple-effect" for="finger">
                <input type="radio" id="finger" class="mdl-radio__button" name="1colour" value="255,0,0">
