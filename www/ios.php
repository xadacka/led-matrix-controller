...
<?php
include('php-emoji/lib/emoji.php');
          ...
          <span class="text-description" style="color: rgb(<?php echo $visColour ?>)">Message changed to "
            ...
            <form method="post" action="sender.php">
              ...
              <label class="mdl-radio mdl-js-radio mdl-js-ripple-effect" for="1white">
                <input type="radio" id="1white" class="mdl-radio__button" name="1colour" value="255,255,255" checked>
              ...
              <!-- message -->
              <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                <input name="message" class="mdl-textfield__input" >
              ...
              <label class="mdl-radio mdl-js-radio mdl-js-ripple-effect" for="white">
                <input type="radio" id="white" class="mdl-radio__button" name="colour" value="255,255,255" checked>
                <span class="mdl-radio__label">White
                </span>
              </label>  
